...
Pullora розвивається у трьох паралельних напрямах: базовий лаунчер, AI Agent / Workspace і дизайн. Цей файл є коротким індексом, а деталізовані плани винесені окремо.
...
- Backlog items remain future optional enhancements and are not release blockers.
